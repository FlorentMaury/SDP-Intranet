...
<nav class="m-3 my-5">
    <ul class="d-flex justify-content-center align-items-center flex-wrap flex-sm-row">
        ...
        <li id="userSchoolButton">
            <img class="m-2" src="./public/assets/school.svg" alt="Ecoles">
            <p class="m-2">Niveau scolaire</p>
        </li>
        <li id="userExpButton">
            <img class="m-2" src="./public/assets/work.svg" alt="Expériences">
            <p class="m-2">
        ...
        <li id="userTimeBankButton">
            <img class="m-2" src="./public/assets/time.svg" alt="Poste">
            <p class="m-2">
                Banque de temps
            </p>
        </li>
        <li>
            <button type="button" href="" class="btn btn-danger me-2">
...
<div id="userSchool" class="border rounded m-2 p-3 text-center">
    ...
    <div class="userExpGrid d-flex flex-column flex-md-row">
        <div class="expFirstItem border rounded m-1 p-3">
            <p class="p-3">Première école : <?php if (empty($data['school_1'])) {
                                                echo 'A completer';
                                            } else {
                                                echo $data['school_1'];
                                            } ?>
            </p>
            <p class="p-3">Date de début : <?php if (empty($data['school_1_start'])) {
                                                echo 'A completer';
                                            } else {
                                                echo $data['school_1_start'];
                                            } ?>
            </p>
            <p class="p-3">Date de fin : <?php if (empty($data['school_1_end'])) {
                                                echo 'A completer';
                                            } else {
            ...
            <div class="userInfosDiplomaCards">
                <p class="userInfosDiplomaCard p-3">
                    Diplôme obtenu :
        ...
        ?>
            ...
            <div class="expSecondItem border rounded m-1 p-3">
                <p class="p-3">Seconde école : <?php if (empty($data['school_2'])) {
                                                    echo 'A completer';
                                                } else {
                                                    echo $data['school_2'];
                                                } ?>
                </p>
                <p class="p-3">Date de début : <?php if (empty($data['school_2_start'])) {
                                                    echo 'A completer';
                                                } else {
                                                    echo $data['school_2_start'];
                                                } ?>
                </p>
                <p class="p-3">Date de fin : <?php if (empty($data['school_2_end'])) {
                                                    echo 'A completer';
                                                } else {
        ...
        ?>
            ...
            <div class="expThirdItem border rounded m-1 p-3">
                <p class="p-3">Troisième école : <?php if (empty($data['school_3'])) {
                                                        echo 'A completer';
                                                    } else {
                                                        echo $data['school_3'];
                                                    } ?>
                </p>
                <p class="p-3">Date de début : <?php if (empty($data['school_3_start'])) {
                                                    echo 'A completer';
                                                } else {
                                                    echo $data['school_3_start'];
                                                } ?>
                </p>
                <p class="p-3">Date de fin : <?php if (empty($data['school_3_end'])) {
                                                    echo 'A completer';
                                                } else {
...
<div id="userExp" class="border rounded m-2 p-3 text-center">
    ...
    <div class="userExpGrid d-flex flex-column flex-md-row">
        <div class="expFirstItem border rounded m-1 p-3">
            <p class="p-3">Première expérience : <?php if (empty($data['job_1'])) {
                                                        echo 'A completer';
                                                    } else {
                                                        echo $data['job_1'];
                                                    } ?>
            </p>
            <p class="p-3">Date de début : <?php if (empty($data['job_1_start'])) {
                                                echo 'A completer';
                                            } else {
                                                echo $data['job_1_start'];
                                            } ?>
            </p>
            <p class="p-3">Date de fin : <?php if (empty($data['job_1_end'])) {
                                                echo 'A completer';
                                            } else {
                                                echo $data['job_1_end'];
                                            } ?>
            </p>
            <p class="p-3">Missions : <?php if (empty($data['job_1_exp'])) {
                                            echo 'A completer';
                                        } else {
                                            echo $data['job_1_exp'];
                                        } ?></p>
        ...
        ?>
            ...
            <div class="expSecondItem border rounded m-1 p-3">
                <p class="p-3">Seconde expérience : <?php if (empty($data['job_2'])) {
                                                        echo 'A completer';
                                                    } else {
                                                        echo $data['job_2'];
                                                    } ?>
                </p>
                <p class="p-3">Date de début : <?php if (empty($data['job_2_start'])) {
                                                    echo 'A completer';
                                                } else {
                                                    echo $data['job_2_start'];
                                                } ?>
                </p>
                <p class="p-3">Date de fin : <?php if (empty($data['job_2_end'])) {
                                                    echo 'A completer';
                                                } else {
                                                    echo $data['job_2_end'];
                                                } ?>
                </p>
                <p class="p-3">Missions : <?php if (empty($data['job_2_exp'])) {
                                                echo 'A completer';
                                            } else {
                                                echo $data['job_2_exp'];
                                            } ?></p>
        ...
        ?>
            ...
            <div class="expThirdItem border rounded m-1 p-3">
                <p class="p-3">Troisième expérience : <?php if (empty($data['job_3'])) {
                                                            echo 'A completer';
                                                        } else {
                                                            echo $data['job_3'];
                                                        } ?>
                </p>
                <p class="p-3">Date de début : <?php if (empty($data['job_3_start'])) {
                                                    echo 'A completer';
                                                } else {
                                                    echo $data['job_3_start'];
                                                } ?>
                </p>
                <p class="p-3">Date de fin : <?php if (empty($data['job_3_end'])) {
                                                    echo 'A completer';
                                                } else {
                                                    echo $data['job_3_end'];
                                                } ?>
                </p>
                <p class="p-3">Missions : <?php if (empty($data['job_3_exp'])) {
                                                echo 'A completer';
                                            } else {
                                                echo $data['job_3_exp'];
                                            } ?></p>
...
<div id="userContract" class="border rounded m-2 p-3 text-center">
    ...
    <div class="expItems">
        ...
        <button class="btn btn-md btn-light p-2" type="submit">
            <a class="nav-link" data-bs-toggle="modal" data-bs-target="#modifyContractWeek">
                <img src="./public/assets/settings.svg" alt="Modifier">
            </a>
        </button>
    </div>
